...
<div class="az-header">
    <div class="container">
        <div class="az-header-left">
            <a href="index.php?id=<?php echo $collector_id; ?>" class="az-logo">
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="az-menu-sub">
                        <div class="container">
                            <nav class="nav">
                                <a href="add-loan.php?id=<?php echo $collector_id; ?>" class="nav-link"><i class="typcn typcn-upload-outline"></i> Your Loan</a>
                            </nav>
                        </div>
                    </div>
                </li>
                <li class="nav-item"><a href="postcateg.php?id=<?php echo $collector_id; ?>" class="nav-link"><i class="typcn typcn-book"></i> Documentation</a></li>
                <li class="nav-item"><a href="customerlist.php?id=<?php echo $collector_id; ?>" class="nav-link"><i class="typcn typcn-group"></i> Customer List</a></li>
                <li class="nav-item"><a href="revenue.php?id=<?php echo $collector_id; ?>" class="nav-link"><i class="typcn typcn-chart-bar-outline"></i> Dashboard</a></li>
            </ul>
        </div>
    ...
    <?php endif; ?>
                ...
                <div class="dropdown-menu">
                        ...
                        <?php if ($notification_count > 0): ?>
                            <?php while ($notification = mysqli_fetch_assoc($notifications)): ?>
                                <div class="media <?php echo $notification['status'] == 0 ? 'new' : ''; ?>">
                                    ...
                                    <img src="./images/<?php echo (!empty($notification['sender_image'])) ? $notification['sender_image'] : '1.png'; ?>" alt="User">
                                    </div>
                    ...
                    <div class="dropdown-footer">
                        <a href="view_notifications.php?id=<?php echo $collector_id; ?>">View All Notifications</a>
                    </div>
                </div>
            </div>
            ...
            <div class="dropdown az-profile-menu">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="my_profile.php?id=<?php echo $collector_id; ?>" class="dropdown-item"><i class="typcn typcn-user-outline"></i> My Profile</a>
                    <a href="profile.php?id=<?php echo $collector_id; ?>" class="dropdown-item"><i class="typcn typcn-edit"></i> Edit Profile</a>
                    <a href="./logout.php?id=<?php echo $collector_id; ?>" class="dropdown-item"><i class="typcn typcn-power-outline"></i> Sign Out</a>
                </div>
            </div>
        </div>
    </div>
